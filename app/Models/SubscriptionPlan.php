...
class SubscriptionPlan extends Model {
    protected $fillable = ['name','slug','scope','min_rooms','max_rooms','price_monthly','price_yearly','currency','features','marketing','is_active','sort_order'];
    protected $appends = ['effective_price_yearly'];
    protected function casts(): array { return ['features'=>'array','marketing'=>'array','is_active'=>'boolean','price_monthly'=>'decimal:3','price_yearly'=>'decimal:3']; }
