...
class StorePlanRequest extends FormRequest {
    ...
    public static function marketingRules(): array {
        return [
            ...
            'marketing.price_note_yearly'    => ['sometimes', 'array'],
            'marketing.price_note_yearly.fr' => ['required_with:marketing.price_note_yearly', 'string', 'max:150'],
            'marketing.price_note_yearly.en' => ['nullable', 'string', 'max:150'],
            'marketing.price_note_yearly.ar' => ['nullable', 'string', 'max:150'],
